...
#if (IMC_DI_XDIR == 1)
#define IMC_DI_NY       (167) // TODO: MUST CHANGE THIS DEPENDING ON STORAGE RING CONFIG
#define IMC_DI_NU       (167) // TODO: MUST CHANGE THIS DEPENDING ON STORAGE RING CONFIG
#else
#define IMC_DI_NY       (165) // TODO: MUST CHANGE THIS DEPENDING ON STORAGE RING CONFIG
#define IMC_DI_NU       (165) // TODO: MUST CHANGE THIS DEPENDING ON STORAGE RING CONFIG
#endif
