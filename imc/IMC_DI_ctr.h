...
#define IMC_DI_NY       (171) // TODO: MUST CHANGE THIS DEPENDING ON STORAGE RING CONFIG
#define IMC_DI_NU       (172) // TODO: MUST CHANGE THIS DEPENDING ON STORAGE RING CONFIG
#if (defined(SOC_C6678) && (USE_IPC==1))
